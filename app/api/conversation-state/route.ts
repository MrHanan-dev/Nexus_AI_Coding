  ...
  try {
    ...
    switch (action) {
      ...
      case 'clear-old':
        ...
        if (!global.conversationState) {
          // If no conversation state exists, create a new one instead of returning an error
          global.conversationState = {
            conversationId: `conv-${Date.now()}`,
            startedAt: Date.now(),
            lastUpdated: Date.now(),
          ...
          console.log('[conversation-state] Created new conversation state (no existing state to clear)');
      ...
      case 'update':
        if (!global.conversationState) {
          // If no conversation state exists, create a new one
          global.conversationState = {
            conversationId: `conv-${Date.now()}`,
            startedAt: Date.now(),
            lastUpdated: Date.now(),
          ...
          console.log('[conversation-state] Created new conversation state for update');
        }
